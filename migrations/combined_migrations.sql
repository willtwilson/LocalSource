...
INSERT INTO vendor_types (id, name, description)
VALUES 
  ('11111111-1111-1111-1111-111111111111', 'Hedge Veg', 'Local produce sold from roadside stands')
ON CONFLICT (id) DO NOTHING;

INSERT INTO vendors (id, name, description, location, vendor_type_id, is_verified)
VALUES (
  '22222222-2222-2222-2222-222222222222',
  'Test Hedge Veg Stand',
  'A test vendor for geospatial queries',
  ST_SetSRID(ST_MakePoint(-2.1035, 49.1805), 4326),
